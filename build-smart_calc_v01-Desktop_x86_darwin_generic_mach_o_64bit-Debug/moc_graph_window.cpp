...
#include <memory>
#include "../smart_calc_v01/graph_window.h"
...
void graph_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (graph_window::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&graph_window::firstWindow)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<graph_window, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
